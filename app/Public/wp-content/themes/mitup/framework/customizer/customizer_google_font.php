 ...
 */
 class Google_Font_Dropdown_Custom_Control extends WP_Customize_Control{
    ...
    {
        $this->fonts = $this->mitup_get_fonts();
            ...
            ?>
                <label style="margin-bottom: 10px; margin-top: 10px; display:block;">
                    ...
                    <select <?php $this->link(); ?>>
                        <?php 
                            if( get_theme_mod('event_custom_font','') != '' ){
                                $cus_fonts = explode(',', get_theme_mod('event_custom_font',''));
     ...
     * @return String
     */
    public function mitup_get_fonts( $amount = '1000' ){

        $fontFile = MITUP_THEME_URI.'/framework/customizer/cache/google-web-fonts.txt';
        $url = $fontFile;
